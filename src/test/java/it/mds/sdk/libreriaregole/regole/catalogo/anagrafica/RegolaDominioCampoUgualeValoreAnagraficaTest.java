...
class RegolaDominioCampoUgualeValoreAnagraficaTest {
    @Mock
    ...
    RegolaDominioCampoUgualeValoreAnagrafica regola;
    ...
    void init() {
        ...
        parametri.put("parametroCondizionante", "5");
        parametriTest = new Parametri();
        parametriTest.setParametriMap(parametri);

        regola = spy(new RegolaDominioCampoUgualeValoreAnagrafica("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaDominioCampoUgualeValoreAnagrafica regola = new RegolaDominioCampoUgualeValoreAnagrafica();
        assertTrue(regola instanceof RegolaDominioCampoUgualeValoreAnagrafica);
    }
    ...
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        recordAnagraficas.add(new RecordAnagrafica(LocalDate.of(1901, 1, 1).atStartOfDay(), LocalDate.of(2100, 1, 1).atStartOfDay(), "ADD"));
        ...
        Mockito.when(recordMockito.getCampo("campoCondizionante")).thenReturn("5");
    ...
    @Test
    void validaKO1() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {

        List<RecordAnagrafica> recordAnagraficas = new ArrayList<>();
        recordAnagraficas.add(new RecordAnagrafica(null, null, "ADD"));
    ...
    void validaOK() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("campoDaValidare")).thenReturn("ADD1");
        Mockito.when(recordMockito.getCampo("campoCondizionante")).thenReturn("6");
        Mockito.when(recordMockito.getCampo("sampmatcodeLegis")).thenReturn("smcl");
