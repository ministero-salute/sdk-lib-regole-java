...
public class RegolaDominioCampoDiversoValoreAnagraficaTest {
    @Mock
    ...
    RegolaDominioCampoDiversoValoreAnagrafica regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDominioCampoDiversoValoreAnagrafica("TEST", "TEST", "TEST", parametriTest));
    }


    @Test
    void costruttoreVuoto() {
        RegolaDominioCampoDiversoValoreAnagrafica regola = new RegolaDominioCampoDiversoValoreAnagrafica();
        assertTrue(regola instanceof RegolaDominioCampoDiversoValoreAnagrafica);
    }
