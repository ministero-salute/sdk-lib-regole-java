...
class RegolaB98ErroreDurataContrattoTest {
    ...
    RegolaB98ErroreDurataContratto regola;
    ...
    void init() {
        ...
        parametri.put("durantaContratto", "120");
        ...
        regola = spy(new RegolaB98ErroreDurataContratto("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void validaCostruttore() {
        RegolaB98ErroreDurataContratto regola = new RegolaB98ErroreDurataContratto();
        assertTrue(regola instanceof RegolaB98ErroreDurataContratto);
    }
    ...
    void validaOk() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("durataDelContratto")).thenReturn("100");
    ...
    void validaOkSeCampoDaValidareNull() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("durataDelContratto")).thenReturn(null);
        Mockito.when(recordMockito.getCampo("annoStipulaContratto")).thenReturn("2017");
        Mockito.when(recordMockito.getCampo("identificativoDiIscrizioneInBancaDatiRepertorio")).thenReturn("smcb");
        Mockito.when(recordMockito.getCampo("tipoDispositivoMedico")).thenReturn("smcl");
    ...
    @Test
    void validaOkSeAnnoMinoreConfronto() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
    ...
    void validaKO() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("durataDelContratto")).thenReturn("130");
        Mockito.when(recordMockito.getCampo("annoStipulaContratto")).thenReturn("2017");
        Mockito.when(recordMockito.getCampo("identificativoDiIscrizioneInBancaDatiRepertorio")).thenReturn("smcb");
        Mockito.when(recordMockito.getCampo("tipoDispositivoMedico")).thenReturn("smcl");
    ...
    @Test
    void validaOkSeCampiNonInAnag() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        Mockito.when(recordMockito.getCampo("durataDelContratto")).thenReturn("100");
        Mockito.when(recordMockito.getCampo("annoStipulaContratto")).thenReturn("2017");
        Mockito.when(recordMockito.getCampo("identificativoDiIscrizioneInBancaDatiRepertorio")).thenReturn("smdb");
        Mockito.when(recordMockito.getCampo("tipoDispositivoMedico")).thenReturn("smcl");
    ...
    void validaKOException() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        ...
        assertThrows(ValidazioneImpossibileException.class, () -> regola.valida("durataDelContratto", recordMockito));
    }
}