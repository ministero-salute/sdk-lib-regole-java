...
class RegolaDominioValoriAnagraficaFacoltativo2ConParametroTest {
    @Mock
    ...
    RegolaDominioValoriAnagraficaFacoltativo2ConParametro regola;
    ...
    void modalitaRegolaY() {
        ...
        regola = spy(new RegolaDominioValoriAnagraficaFacoltativo2ConParametro("TEST", "TEST", "TEST", parametriTest));
    }

    void modalitaRegolaN() {
        MockitoAnnotations.openMocks(this);
        Map<String, String> parametri = new HashMap<>();
        parametri.put("nomeTabella", "ANAG_AVN_ASL");
        parametri.put("modalitaRegola", "N");
    ...
    void costruttoreVuoto() {
        RegolaDominioValoriAnagraficaFacoltativo2ConParametro regola = new RegolaDominioValoriAnagraficaFacoltativo2ConParametro();
        assertTrue(regola instanceof RegolaDominioValoriAnagraficaFacoltativo2ConParametro);
    }
