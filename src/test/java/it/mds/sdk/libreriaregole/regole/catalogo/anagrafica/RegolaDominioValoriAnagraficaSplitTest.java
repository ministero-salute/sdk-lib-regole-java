...
class RegolaDominioValoriAnagraficaSplitTest {
    @Mock
    ...
    RegolaDominioValoriAnagraficaSplit regola;
    ...
    void init0() {
        ...
        regola = spy(new RegolaDominioValoriAnagraficaSplit("TEST", "TEST", "TEST", parametriTest));
    }
    void init1() {
        MockitoAnnotations.openMocks(this);
        Map<String, String> parametri = new HashMap<>();
    ...
    void costruttoreVuoto() {
        RegolaDominioValoriAnagraficaSplit regola = new RegolaDominioValoriAnagraficaSplit();
        assertTrue(regola instanceof RegolaDominioValoriAnagraficaSplit);
    }
    @Test
    void validaKO() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        ...
        recordAnagraficas.add(new RecordAnagrafica(LocalDate.of(1901, 1, 1).atStartOfDay(), LocalDate.of(2100, 1, 1).atStartOfDay(), "ADD#ADD"));
        recordAnagraficas.add(new RecordAnagrafica(LocalDate.of(1901, 1, 1).atStartOfDay(), LocalDate.of(2100, 1, 1).atStartOfDay(), "mock"));

        Mockito.when(recordMockito.getCampo("campoDaValidare")).thenReturn("ADD#ADD");
    ...
    void validaKO1() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, MalformedRegistryException, RegistryNotFoundException {
        init0();
        List<RecordAnagrafica> recordAnagraficas = new ArrayList<>();
        recordAnagraficas.add(new RecordAnagrafica(null,null, "ADD#ADD"));
