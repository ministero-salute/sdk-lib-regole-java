...
class RegolaBR2060Test {
    ...
    void init(){
        ...
        regola = spy(new RegolaBR2060("TEST", "TEST", "TEST", parametriTest));
    }

    @Test
    void costruttoreVuoto() {
        RegolaBR2060 regola = new RegolaBR2060();
        assertTrue(regola instanceof RegolaBR2060);
    }
