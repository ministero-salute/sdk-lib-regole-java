...
class RegolaMaggioranzaCrossCampoTest {
    ...
    void costruttoreVuoto() {
        RegolaMaggioranzaCrossCampo regola = new RegolaMaggioranzaCrossCampo();
        assertTrue(regola instanceof RegolaMaggioranzaCrossCampo);
    }
    ...
    void validaOK() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        ...
        RegolaMaggioranzaCrossCampo regola = new RegolaMaggioranzaCrossCampo("RegolaVerificaEtaString", "3941", "Codice 3941", parametriTest);
    ...
    void validaKOException() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        ...
        RegolaMaggioranzaCrossCampo regola = new RegolaMaggioranzaCrossCampo("RegolaMaggioranzaCrossCampoString", "3941", "Codice 3941", parametriTest);
