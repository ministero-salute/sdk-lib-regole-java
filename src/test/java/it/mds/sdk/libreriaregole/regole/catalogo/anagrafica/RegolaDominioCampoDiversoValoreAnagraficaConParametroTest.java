...
public class RegolaDominioCampoDiversoValoreAnagraficaConParametroTest {
    @Mock
    ...
    RegolaDominioCampoDiversoValoreAnagraficaConParametro regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDominioCampoDiversoValoreAnagraficaConParametro("TEST", "TEST", "TEST", parametriTest));
    }


    @Test
    void costruttoreVuoto() {
        RegolaDominioCampoDiversoValoreAnagraficaConParametro regola = new RegolaDominioCampoDiversoValoreAnagraficaConParametro();
        assertTrue(regola instanceof RegolaDominioCampoDiversoValoreAnagraficaConParametro);
    }
