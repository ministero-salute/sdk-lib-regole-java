...
public class RegolaDominioCampoDiversoValoreAnagraficaSplitTest {
    @Mock
    ...
    RegolaDominioCampoDiversoValoreAnagraficaSplit regola;
    ...
    void init(){
        ...
        regola = spy(new RegolaDominioCampoDiversoValoreAnagraficaSplit("TEST", "TEST", "TEST", parametriTest));
    }


    @Test
    void costruttoreVuoto() {
        RegolaDominioCampoDiversoValoreAnagraficaSplit regola = new RegolaDominioCampoDiversoValoreAnagraficaSplit();
        assertTrue(regola instanceof RegolaDominioCampoDiversoValoreAnagraficaSplit);
    }
