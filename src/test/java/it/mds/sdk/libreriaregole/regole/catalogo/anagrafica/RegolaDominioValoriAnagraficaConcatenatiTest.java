...
class RegolaDominioValoriAnagraficaConcatenatiTest {
    ...
    RegolaDominioValoriAnagraficaConcatenati regola;
    ...
    void init() {
        ...
        regola = spy(new RegolaDominioValoriAnagraficaConcatenati("RegolaDominioValoriAnagraficaConcatenati", "AAA", "AAA", parametriTest));
    }
