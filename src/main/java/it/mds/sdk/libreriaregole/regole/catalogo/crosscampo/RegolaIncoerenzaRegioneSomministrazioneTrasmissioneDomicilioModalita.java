...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita")
public class RegolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita extends RegolaGenerica {

    public RegolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita(String nome, String codErrore, String desErrore, Parametri parametri) {
