...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioCampoDiversoValoreAnagraficaSplit")
public class RegolaDominioCampoDiversoValoreAnagraficaSplit extends RegolaGenerica {

    public RegolaDominioCampoDiversoValoreAnagraficaSplit(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            List<RecordAnagrafica> listaValori = gestoreAnagrafica.richiediAnagrafica(nomeTabella, campiDtoConcatenati, false).getRecordsAnagrafica();
            ...
            if (!parametroCondizionante.equals(valoreCondizionante) &&
                    !listaDominio.contains(campiDtoConcatenati)
            ) {
