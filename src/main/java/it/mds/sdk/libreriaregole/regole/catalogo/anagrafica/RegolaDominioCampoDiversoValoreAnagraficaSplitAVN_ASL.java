...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioCampoDiversoValoreAnagraficaSplitAVN_ASL")
public class RegolaDominioCampoDiversoValoreAnagraficaSplitAVN_ASL extends RegolaGenerica {

    public RegolaDominioCampoDiversoValoreAnagraficaSplitAVN_ASL(String nome, String codErrore, String desErrore, Parametri parametri) {
