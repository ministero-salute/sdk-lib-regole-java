...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDataAntecedenteCondizionataCampoFacoltativo")
public class RegolaDataAntecedenteCondizionataCampoFacoltativo extends RegolaGenerica {

    public RegolaDataAntecedenteCondizionataCampoFacoltativo(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            if("RE".equalsIgnoreCase(modalita) && LocalDate.parse(dataDaComparareString).isBefore(LocalDate.parse(dataNascita))){
