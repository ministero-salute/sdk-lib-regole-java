...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioCampoDiversoValoreAnagraficaConParametro")
public class RegolaDominioCampoDiversoValoreAnagraficaConParametro extends RegolaGenerica {

    public RegolaDominioCampoDiversoValoreAnagraficaConParametro(String nome, String codErrore, String desErrore, Parametri parametri) {
