...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncoerenzaStatoEsteroConComuneASL2")
public class RegolaIncoerenzaStatoEsteroConComuneASL2 extends RegolaGenerica {

    public RegolaIncoerenzaStatoEsteroConComuneASL2(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            if(campoDaValidare != null && "IT".equals(String.valueOf(campoDaValidare))) {
                ...
                if((codiceComuneResidenza != null && "999999".equals(String.valueOf(codiceComuneResidenza)) ) ||
