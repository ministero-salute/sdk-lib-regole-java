...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioValoriAnagraficaSplittatiCampoDiverso")
public class RegolaDominioValoriAnagraficaSplittatiCampoDiverso extends RegolaGenerica {

    public RegolaDominioValoriAnagraficaSplittatiCampoDiverso(
