...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioValoriAnagraficaConcatenatiParametroPeriodoAnno")
public class RegolaDominioValoriAnagraficaConcatenatiParametroPeriodoAnno extends RegolaDominioValoriAnagraficaConcatenatiPeriodoAnno {

    public RegolaDominioValoriAnagraficaConcatenatiParametroPeriodoAnno(String nome, String codErrore, String desErrore, Parametri parametri) {
     ...
     * e data validita tabella anagrafica compresa nel periodo-anno del DTO
     *
