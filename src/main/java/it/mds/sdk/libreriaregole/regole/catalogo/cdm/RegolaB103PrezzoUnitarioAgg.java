...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaB103PrezzoUnitarioAgg")
public class RegolaB103PrezzoUnitarioAgg extends RegolaGenerica {

    public RegolaB103PrezzoUnitarioAgg(String nome, String codErrore, String desErrore, Parametri parametri) {
     ...
     * e tipo_contr uguale a "CA" e amb_val è uguale a 4 allora il campo prezzo_agg deve essere diverso da zero
     *
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            String ambito = (String) recordDtoGenerico.getCampo(this.getParametri().getParametriMap().get("ambitoDiValenzaDelContratto"));
            ...
            if (annoDaConfrontare < annoConfronto) {
                ...
                if (listaDominio.contains(campiDtoConcatenati) && "CA".equalsIgnoreCase(tipologiaDiContratto) && "4".equalsIgnoreCase(ambito)) {
