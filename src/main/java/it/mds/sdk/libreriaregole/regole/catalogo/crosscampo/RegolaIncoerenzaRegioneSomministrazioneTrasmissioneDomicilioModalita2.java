...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita2")
public class RegolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita2 extends RegolaGenerica {

    public RegolaIncoerenzaRegioneSomministrazioneTrasmissioneDomicilioModalita2(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            if(
                    !Objects.equals(regioneSomministazione, codiceRegioneInput) &&
                    "MV".equalsIgnoreCase(modalita)
            ){
