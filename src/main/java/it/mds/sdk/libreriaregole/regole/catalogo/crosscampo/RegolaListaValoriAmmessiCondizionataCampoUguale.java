...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaListaValoriAmmessiCondizionataCampoUguale")
public class RegolaListaValoriAmmessiCondizionataCampoUguale extends RegolaGenerica {

    public RegolaListaValoriAmmessiCondizionataCampoUguale(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            String valoreCampoCondizionante = (String) (recordDtoGenerico.getCampo(this.getParametri().getParametriMap().get("nomeCampoCondizionante"))); //valore del campo del DTO
            ...
            if (parametroCampoCondizionante.equals(valoreCampoCondizionante) && !listaValori.contains(valoreCampoDaValidare)) {
