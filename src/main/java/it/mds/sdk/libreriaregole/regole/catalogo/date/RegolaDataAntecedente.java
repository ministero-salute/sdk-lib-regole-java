...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDataAntecedente")
public class RegolaDataAntecedente extends RegolaGenerica {

    public static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    public RegolaDataAntecedente(String nome, String codErrore, String desErrore, Parametri parametri) {
