...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaB99ErroreFormaNegoziazione")
public class RegolaB99ErroreFormaNegoziazione extends RegolaGenerica {

    public RegolaB99ErroreFormaNegoziazione(String nome, String codErrore, String desErrore, Parametri parametri) {
     ...
     * e amb_val è uguale a 4 allora il campo forma_neg deve essere diverso da NC
     *
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            if (annoDaConfrontare < annoConfronto) {
                ...
                if (listaDominio.contains(campiDtoConcatenati) && "4".equalsIgnoreCase(ambitoValenza)) {
                    if (!"NC".equalsIgnoreCase(campoDaValidare)) {
