...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncoerenzaRegioneSomministrazioneResidenzaDomicilio")
public class RegolaIncoerenzaRegioneSomministrazioneResidenzaDomicilio extends RegolaGenerica {

    public RegolaIncoerenzaRegioneSomministrazioneResidenzaDomicilio(String nome, String codErrore, String desErrore, Parametri parametri) {
