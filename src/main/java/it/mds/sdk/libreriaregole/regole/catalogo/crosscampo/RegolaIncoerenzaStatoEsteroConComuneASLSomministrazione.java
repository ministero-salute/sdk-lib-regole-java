...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaIncoerenzaStatoEsteroConComuneASLSomministrazione")
public class RegolaIncoerenzaStatoEsteroConComuneASLSomministrazione extends RegolaGenerica {

    public RegolaIncoerenzaStatoEsteroConComuneASLSomministrazione(String nome, String codErrore, String desErrore, Parametri parametri) {
