...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDataPosteriore")
public class RegolaDataPosteriore extends RegolaGenerica {

    public static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    public RegolaDataPosteriore(String nome, String codErrore, String desErrore, Parametri parametri) {
