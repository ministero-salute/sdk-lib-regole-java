...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDataAntecedenteCondizionale")
public class RegolaDataAntecedenteCondizionale extends RegolaGenerica {

    public static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    public RegolaDataAntecedenteCondizionale(String nome, String codErrore, String desErrore, Parametri parametri) {
        super(nome, codErrore, desErrore, parametri);
    }

    /**
     * Controlla che il valore del campo passato in ingresso(data, se valorizzata) sia antecedente a un'altra data all'interno dello stesso DTO.
