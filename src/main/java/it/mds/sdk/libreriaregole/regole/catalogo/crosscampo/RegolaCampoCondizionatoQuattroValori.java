...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaCampoCondizionatoQuattroValori")
public class RegolaCampoCondizionatoQuattroValori extends RegolaGenerica {

    public RegolaCampoCondizionatoQuattroValori(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        log.debug("{} - nomeCampo[{}] recordDtoGenerico[{}] - BEGIN",
                RegolaCampoCondizionatoQuattroValori.class.getName(), nomeCampo, recordDtoGenerico);
        ...
        try {
            ...
            log.debug("{} - nomeCampo[{}] recordDtoGenerico[{}] - campoDaValidare[{}] " +
                    ...
                    RegolaCampoCondizionatoQuattroValori.class.getName(), nomeCampo, recordDtoGenerico, campoDaValidare,
            ...
            if ((parametroCondizionante1.equals(campoCondizionante1) || parametroCondizionante2.equals(campoCondizionante2))
                    && parametroCondizionante3.equals(campoCondizionante3)
                    && !parametroDaValidare.equals(campoDaValidare)) {
            ...
            log.error("{} - nomeCampo[{}] recordDtoGenerico[{}] - Error: {}",
                    RegolaCampoCondizionatoQuattroValori.class.getName(), nomeCampo, recordDtoGenerico, e.getMessage(), e);
