...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaCampoCondizionatoTreValori")
public class RegolaCampoCondizionatoTreValori extends RegolaGenerica {

    public RegolaCampoCondizionatoTreValori(String nome, String codErrore, String desErrore, Parametri parametri) {
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        log.debug("{} - nomeCampo[{}] recordDtoGenerico[{}] - BEGIN",
                RegolaCampoCondizionatoTreValori.class.getName(), nomeCampo, recordDtoGenerico);
        ...
        try {
            ...
            log.debug("{} - nomeCampo[{}] recordDtoGenerico[{}] - campoDaValidare[{}] campoCondizionante1[{}] campoCondizionante2[{}] " +
                    ...
                    RegolaCampoCondizionatoTreValori.class.getName(), nomeCampo, recordDtoGenerico, campoDaValidare,
            ...
            log.error("{} - nomeCampo[{}] recordDtoGenerico[{}] - Error: {}",
                    RegolaCampoCondizionatoTreValori.class.getName(), nomeCampo, recordDtoGenerico, e.getMessage(), e);
