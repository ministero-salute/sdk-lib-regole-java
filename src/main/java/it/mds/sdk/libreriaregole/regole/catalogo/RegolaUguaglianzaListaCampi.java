...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaUguaglianzaListaCampi")
public class RegolaUguaglianzaListaCampi extends RegolaGenerica {

    public RegolaUguaglianzaListaCampi(String nome, String codErrore, String desErrore, Parametri parametri) {
        super(nome, codErrore, desErrore, parametri);
    }

    /**
     **
     * Verifica che n valori del DTO in ingresso siano uguali ad altrettanti n valori del DTO.
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        else if(concatCampiDaConfrontare.length() != 0 && concatCampiConfronto.length() != 0 && concatCampiDaConfrontare.toString().equals(concatCampiConfronto.toString())){
            listaEsiti.add(creaEsitoOk(nomeCampo));
        }else{
