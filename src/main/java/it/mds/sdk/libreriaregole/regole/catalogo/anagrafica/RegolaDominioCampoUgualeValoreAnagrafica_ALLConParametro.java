...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaDominioCampoUgualeValoreAnagrafica_ALLConParametro")
public class RegolaDominioCampoUgualeValoreAnagrafica_ALLConParametro extends RegolaGenerica {

    public RegolaDominioCampoUgualeValoreAnagrafica_ALLConParametro(String nome, String codErrore, String desErrore, Parametri parametri) {
