...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaB98ErroreDurataContratto")
public class RegolaB98ErroreDurataContratto extends RegolaGenerica {

    public RegolaB98ErroreDurataContratto(String nome, String codErrore, String desErrore, Parametri parametri) {
     ...
     * allora il campo durata_contr deve essere minore o uguale a 120
     *
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            Integer durataConfronto = Integer.valueOf(this.getParametri().getParametriMap().get("durantaContratto"));
            ...
            if (annoDaConfrontare < annoConfronto) {
                ...
                if (listaDominio.contains(campiDtoConcatenati)) {
                    if (Integer.valueOf(campoDaValidare) <= durataConfronto) {
