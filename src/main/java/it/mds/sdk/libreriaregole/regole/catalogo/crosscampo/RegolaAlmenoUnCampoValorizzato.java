...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaAlmenoUnCampoValorizzato")
public class RegolaAlmenoUnCampoValorizzato extends RegolaGenerica {

    public RegolaAlmenoUnCampoValorizzato(String nome, String codErrore, String desErrore, Parametri parametri) {
        super(nome, codErrore, desErrore, parametri);
    }

    /**
     * Dati 2 campi del DTO, almeno un campo dei 2 deve essere valorizzato
     *
    ...
    public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
        ...
        try {
            ...
            throw new ValidazioneImpossibileException("Impossibile validare la RegolaAlmenoUnCampoValorizzato del campo " + nomeCampo);
        }
        return listaEsiti;
    }
}
