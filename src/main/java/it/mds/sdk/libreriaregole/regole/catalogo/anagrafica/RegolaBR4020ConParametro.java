...
@Slf4j
@NoArgsConstructor
@XmlDiscriminatorValue("regolaBR4020ConParametro")
public class RegolaBR4020ConParametro extends RegolaGenerica{

	public RegolaBR4020ConParametro(String nome, String codErrore, String desErrore, Parametri parametri) {
	...
	public List<Esito> valida(String nomeCampo, RecordDtoGenerico recordDtoGenerico) {
		...
		try {
			...
			if(!Objects.equals("999999", campoDaValidare) &&
					(Objects.equals("999", codiceAslSomministrazione) ||
							Objects.equals(codiceRegioneSomministrazione, "999") ||
							this.richiediAnagrafica(nomeTabella, concat, recordDtoGenerico).size() == 0 )
			){
